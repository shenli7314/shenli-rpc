...
public class RPCFuture implements Future<Object> {
    ...
    public Object get(long timeout, TimeUnit unit) throws InterruptedException, ExecutionException, TimeoutException {
        System.out.println("========同步前："+System.currentTimeMillis());
    	boolean success = sync.tryAcquireNanos(-1, unit.toNanos(timeout));
    	System.out.println("========同步后："+System.currentTimeMillis());
        if (success) {
            if (this.response != null) {
                return this.response.getResult();
            } else {
    ...
    static class Sync extends AbstractQueuedSynchronizer {
        ...
        protected boolean tryAcquire(int acquires) {
        	System.out.println("=====acquires:"+acquires+",state:"+getState());
            return getState() == done ? true : false;
        }

        protected boolean tryRelease(int releases) {
        	System.out.println("=====releases:"+releases+",state:"+getState());
            if (getState() == pending) {
        ...
        public boolean isDone() {
        	System.out.println("=====done:"+getState());
            getState();
